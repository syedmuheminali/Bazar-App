      ...
      <ScrollView className='flex-1 px-4' contentContainerStyle={!user ? { flex: 1, justifyContent: "center", alignItems: "center" } : { paddingTop: 16 }}>
        {!user ? (
          ...
          <View className='items-center w-full'>
            ...
            <Text className='text-base text-secondary mb-8 text-center w-3/4 px-4'>Log in to view your profile, orders, and address</Text>
          ...
          <View className='items-center mb-8'>
            ...
            {user?.publicMetadata?.role === "admin" && (
              <TouchableOpacity onPress={() => router.push("/admin")} className='bg-primary mt-4 px-6 py-4 rounded-full'>

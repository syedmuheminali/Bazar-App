                ...
                <View className='relative h-[450px] bg-gray-100 mb-6'>
                    <ScrollView horizontal pagingEnabled showsHorizontalScrollIndicator={false} scrollEventThrottle={16} onScroll={(e) => {
                        ...
                        {product.images?.map((image, index) => (
                            <Image key={index} source={{ uri: image }} style={{ width: width, height: 450 }} resizeMode='cover' />
                        ))}
                    </ScrollView>
                    {/* header action */}
                ...
                <View className='px-5'>
                    ...
                    <View className='flex-row justify-between items-start mb-2'>
                        ...
                        <View className='flex-row justify-between items-start mb-2'>
                            ...
                            <Text className='text-sm font-bold ml-1'>4.7</Text>
                            <Text className='text-sm text-secondary ml-1'>(85)</Text>
                        </View>
                    </View>
                    {/* price */}
                    <Text className='text-2xl font-bold text-primary mb-6'>Rs: {product?.price.toFixed(2)}</Text>
